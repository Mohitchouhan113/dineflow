...
// 1. AdminLayout.jsx
write('frontend/src/components/layout/AdminLayout.jsx', `import React, { useState } from 'react';
...
// 2. AdminSidebar.jsx
write('frontend/src/components/layout/AdminSidebar.jsx', `import React from 'react';
...
console.log('Admin layout + sidebar created');
